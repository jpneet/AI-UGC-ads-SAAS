                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            We are an AI video generation platform focused on intelligent models, creative object-based prompting and video synthesis—helping creators turn ideas into cinematic, scalable digital visuals that grow with their vision.
                        </p>
                    </div>
